...
// USE COUNTBY AND MAX TO DO STRETCH GOAL 8
...
var eachFeature2 = function(feature, layer) {
 ...
 //Calling my data from CartoDB with a function
 ...
 getDataFunction("neighborhoods_philadelphia", "listname = 'Overbrook' OR listname = 'Pennypack Park'");


//Calling my data from CartoDB
// var sqlStatement = "listname = 'Overbrook'";
// var sql = new cartodb.SQL({ user: 'eneedham', format: 'geojson' });
// sql.execute("SELECT * FROM neighborhoods_philadelphia WHERE " + sqlStatement).done(function(geojson) {
